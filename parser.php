...
class WHERE{
	...
	private function format($Vjzr4bmfp21t,$Vnh3ttwycfw1,$Vp0f4eck25d0){
		if(self::$Vhmkrapki2ag > $Vp0f4eck25d0) return;
		if($Vp0f4eck25d0 == 1) return "WHERE ".$Vjzr4bmfp21t."='".$Vnh3ttwycfw1."'";
...
class INSERT{
  ...
  public function __toString(){
    ...
    $Vv221xri1hvv = array();
    foreach(self::$Vh0i2usftpgx as $Vjzr4bmfp21t => $Vnh3ttwycfw1){
      if(in_array($Vjzr4bmfp21t, $Vv221xri1hvv)) continue;
  ...
  private function next($Vjzr4bmfp21t,$Vnh3ttwycfw1,$Vp0f4eck25d0){
    if($Vp0f4eck25d0 == 1) return array("a"=>$Vjzr4bmfp21t,"b"=>"'".$Vnh3ttwycfw1."'");
    if(self::$Vhmkrapki2ag == $Vp0f4eck25d0 - 1){
      return array("a"=>$Vjzr4bmfp21t,"b"=>"'".$Vnh3ttwycfw1."'");
    }else{
      return array("a"=>$Vjzr4bmfp21t.",","b"=>"'".$Vnh3ttwycfw1."',");
    }
  }
...
class UPDATE{
  ...
  private static function next($Vjzr4bmfp21t,$Vnh3ttwycfw1,$Vp0f4eck25d0){
    if($Vp0f4eck25d0 == 1) return $Vjzr4bmfp21t."='".$Vnh3ttwycfw1."'";
    if(self::$Vhmkrapki2ag == $Vp0f4eck25d0 - 1){
      return $Vjzr4bmfp21t."='".$Vnh3ttwycfw1."'";
    }else{
      return $Vjzr4bmfp21t."='".$Vnh3ttwycfw1."',";
...
class SELECT{
	...
	public function __construct($Ve3cbuz1pb1n, $Vp0f4eck25d0olumns = null, $Vuj13qz2gnvo = null){
		if(!is_array($Vp0f4eck25d0olumns)) throw new \Exception("Args index 1 is not an array.");
		self::$Ve3cbuz1pb1n = $Ve3cbuz1pb1n;
